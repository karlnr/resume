...
\geometry{left=1.2cm, top=1.0cm, right=1.8cm, bottom=1.5cm, footskip=0.5cm}
...
\titleformat{\section}			    % command
	...
	{\Huge\scshape\raggedright\vspace{-7pt}}  	% set large, small cap, left align
	{}								% label
